...

{
  ...
  eq(seen.length, 24, "владелец видит все пункты");
...

{
  ...
  eq(seen("admin").length, 24, "владелец: все пункты");
  eq(seen("manager").length, 20, "управляющий: без зарплаты, пользователей и групп ИП");
