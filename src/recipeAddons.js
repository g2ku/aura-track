...
//
// В базовых техкартах «Американо», «Латте», «Капучино» и «Фраппучино»
// стояли ванильный сироп 15 г, мёд 15 г и корица 0,5 г — одной тройкой,
// как колонки добавок, перенесённые из таблицы в основу. Владелец
// подтвердил (25.09.2026): это добавки, их продают отдельно. В
// «Американо» ещё и молоко 85 мл — тоже добавка. С ценами сиропа и мёда
// себестоимость этих напитков выходила бы завышенной.
//
