...
//
// Формула живёт в recipeCost.js: её же считает бот на сервере, где
// клиентский firebase (импорт этого модуля) не поднимется.
export { calcRecipeCost, getIngredientCostPerUnit } from "./recipeCost.js";
