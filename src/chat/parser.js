...
const METRICS = [
  ...
  { keys: ["что продав", "что продал", "что покупа", "что берут", "что брали", "что заказыва", "продаваем", "популярн", "хит продаж", "топ товар", "топ продаж", "топ позиц", "не продав", "не продал"], value: "products" },
  // «Сколько заработаем» — про будущее, это прогноз
  { keys: ["заработаем", "заработаю", "выйдем на", "сколько будет к концу"], value: "forecast" },
  { keys: ["касс", "каса", "выручк", "деньг", "денег", "средств", "заработ", "оборот", "доход", "бабк", "бабл", "деньж", "сколько сделал", "сделали за", "сделали вчера", "сделали сегодня"], value: "cash" },
