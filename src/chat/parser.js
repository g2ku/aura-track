...
const METRICS = [
  ...
  { keys: ["во сколько открыл", "во сколько открыва", "когда открыл", "когда открыва", "время открыт", "открылась позже", "открылись позже", "открылась раньше", "опоздал", "опоздан", "позже всех", "раньше всех", "первый чек",
    ...
    "во сколько закрыл", "во сколько закрыва", "когда закрыл", "когда закрыва", "время закрыт", "до скольки", "последний чек", "закрылись раньше", "закрылись позже", "закрывались", "закрываются"], value: "opening" },
