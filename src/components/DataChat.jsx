...
const STARTER = [
  { title: "Сейчас", items: ["Что не так сейчас", "Открытые чеки", "Касса сегодня", "Во сколько открылись точки"] },
  { title: "Деньги", items: ["Касса вчера", "Кто просел за неделю", "Средний чек за неделю", `Сравнить ${PREV_MONTH} с ${monthAgo(2, MONTHS_INS)}`, "Доля Kaspi за неделю"] },
  { title: "Товары и склад", items: ["Что продавалось лучше всего вчера", "Какие товары не продавались за неделю", "Самый дорогой чек за неделю", "Остатки в минусе"] },
  { title: "Разрезы", items: ["Касса по будням за месяц", "В какое время пик продаж?", "Кто из бариста продал больше всех за неделю", "Рост кассы за полгода"] },
];
...
const FOLLOW_UP = {
  ...
  staff: ["Средний чек по бариста за неделю", "Чеки по бариста вчера", "Касса вчера"],
