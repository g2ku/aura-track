...
const STARTER = [
  { title: "Сейчас", items: ["Что не так сейчас", "Открытые чеки", "Касса сегодня", "Кто работал вчера"] },
  { title: "Деньги", items: ["Касса вчера", "Сравни сегодня со вчера в это же время", "Кто просел за неделю", `Сравнить ${PREV_MONTH} с ${monthAgo(2, MONTHS_INS)}`, "Доля Kaspi за неделю"] },
