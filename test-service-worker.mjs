...
// Воркер теперь у всех: бариста работают с телефона, и мгновенный
// запуск нужен им больше всех. Страница берётся сначала из сети, так
// что на старой версии никто не залипнет.

{
  ...
  ok(/syncServiceWorker\(navV2\)/.test(app), "включается вместе с новым интерфейсом");
