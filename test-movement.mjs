...

{
  ...
  // Теперь строже: в ленту не идут НИКАКИЕ чеки — ни пустые, ни с
  // деньгами. Для них на экране есть свой блок с группировкой.
  ok(/IGNORED = new Set\(\["stuck", "nosupply"\]\)/.test(src),
     "лента отбрасывает чеки целиком, а не только пустые");
